Task1<br>
Задание на модификаторы доступа: public, protected, private:<br>
...
Task2<br>
Добавление в List<Integer> нельзя List<int>:<br>
...
Task3<br>
Передачи параметра по ссылке и по значению:<br>
...
Task5<br>
Продолжение работы с массивами:<br>
...
Task7<br>
Inner, Nested, Anonymous и Local классы:<br>
...
Task10<br>
Задание на Collection и Iterator:<br>
...
Task13<br>
Задание на ввод/вывод. Чтение из файла:<br>
